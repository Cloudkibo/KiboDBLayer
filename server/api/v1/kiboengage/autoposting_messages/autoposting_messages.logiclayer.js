...
exports.validateAutopostingSubscriberMessagesPayload = (body) => {
  let bool = true
  let arrayOfRequiredFields = [
    'pageId',
    'companyId',
...
exports.prepareMongoAggregateQuery = (body) => {
  ...
  if (body.match) {
    if (body.match.autopostingId) {
      body.match.autopostingId = mongoose.Types.ObjectId(body.match.autopostingId)
    }
