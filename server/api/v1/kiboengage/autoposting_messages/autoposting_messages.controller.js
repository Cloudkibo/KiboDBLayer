...
exports.index = function (req, res) {
  DataLayer.findAllAutopostingMessagesObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all autoposting messages'
...
exports.query = function (req, res) {
  DataLayer.findAutopostingMessagesUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find autoposting messages'
...
exports.update = function (req, res) {
  DataLayer.updateAutopostingMessage(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update autoposting message'
...
exports.delete = function (req, res) {
  DataLayer.deleteAutopostingMessage(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete autoposting message'
