...
const MongoInterface = require('./autoposting_messages_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/autoposting_messages/autoposting_messages.datalayer.js'

const util = require('util')

exports.findAllAutopostingMessagesObjects = () => {
  return MongoInterface.find()
}

exports.createOneAutopostingMessageObject = (body) => {
...
exports.updateAutopostingMessage = (body) => {
  if (body.purpose) {
...
exports.findAutopostingMessagesUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteAutopostingMessage = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
