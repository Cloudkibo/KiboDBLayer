...
*/
const LogicLayer = require('./abandoned_checkout.logiclayer')
const MongoInterface = require('./abandoned_checkout_interface_mongo')
const logger = require('./../../../../../components/logger')
const TAG = '/api/v1/kiboengage/abandoned_cart/abandoned_checkout/abandoned_checkout.datalayer.js'

const util = require('util')

exports.findAllAbandonedCheckoutObjects = () => {
  return MongoInterface.find()
}

exports.createOneAbandonedCheckoutObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateAbandonedCheckout = (body) => {
  if (body.purpose) {
...
exports.findAbandonedCheckoutUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteAbandonedCheckout = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
