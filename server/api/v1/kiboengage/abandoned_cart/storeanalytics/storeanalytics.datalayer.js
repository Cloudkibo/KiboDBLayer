...
*/
const LogicLayer = require('./storeanalytics.logiclayer')
const MongoInterface = require('./storeanalytics_interface_mongo')
const logger = require('./../../../../../components/logger')
const TAG = '/api/v1/kiboengage/abandoned_cart/storeanalytics/storeanalytics.datalayer.js'

const util = require('util')

exports.findAllStoreAnalyticsObjects = () => {
  return MongoInterface.find()
}

exports.createOneStoreAnalyticsObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateStoreAnalytics = (body) => {
  if (body.purpose) {
...
exports.findStoreAnalyticsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteStoreAnalytics = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
