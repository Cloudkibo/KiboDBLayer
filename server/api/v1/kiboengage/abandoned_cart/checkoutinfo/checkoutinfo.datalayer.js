...
*/
const LogicLayer = require('./checkoutinfo.logiclayer')
const MongoInterface = require('./checkoutinfo_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/abandoned_cart/checkoutinfo/checkoutinfo.datalayer.js'

const util = require('util')

exports.findAllCheckOutInfoObjects = () => {
  return MongoInterface.find()
}

exports.createOneCheckOutInfoObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateCheckOutInfo = (body) => {
  if (body.purpose) {
...
exports.findCheckOutInfoUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteCheckOutInfo = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
