...
*/
const LogicLayer = require('./orderinfo.logiclayer')
const MongoInterface = require('./orderinfo_interface_mongo')
const logger = require('./../../../../../components/logger')
const TAG = '/api/v1/kiboengage/abandoned_cart/orderinfo/orderinfo.datalayer.js'

const util = require('util')

exports.findAllOrderInfoObjects = () => {
  return MongoInterface.find()
}

exports.createOneOrderInfoObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateOrderInfo = (body) => {
  if (body.purpose) {
...
exports.findOrderInfoUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
