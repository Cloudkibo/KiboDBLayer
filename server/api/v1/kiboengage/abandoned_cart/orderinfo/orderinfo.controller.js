...
const DataLayer = require('./orderinfo.datalayer')
const TAG = '/api/v1/kiboengage/abandoned_cart/orderinfo/orderinfo.controller.js'
const { sendSuccessResponse, sendErrorResponse } = require('../../../../../global/response')
const util = require('util')

exports.index = function (req, res) {
  logger.serverLog(TAG, `Index endpoint is hit:`)
  DataLayer.findAllOrderInfoObjects()
    .then(foundObjects => {
...
exports.create = function (req, res) {
  ...
  DataLayer.createOneOrderInfoObject(req.body)
    .then(createdObject => {
...
exports.query = function (req, res) {
  ...
  DataLayer.findOrderInfoUsingQuery(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.update = function (req, res) {
  ...
  DataLayer.updateOrderInfo(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.delete = function (req, res) {
  ...
  DataLayer.deleteOrderInfo(req.body)
    .then(result => {
