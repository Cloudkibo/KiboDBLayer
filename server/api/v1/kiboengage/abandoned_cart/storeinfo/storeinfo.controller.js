...
exports.index = function (req, res) {
  DataLayer.findAllStoreInfoObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all stores info'
...
exports.create = function (req, res) {
  DataLayer.createOneStoreInfoObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create store info'
...
exports.query = function (req, res) {
  DataLayer.findStoreInfoUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find store info'
...
exports.update = function (req, res) {
  DataLayer.updateStoreInfo(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update store info'
...
exports.delete = function (req, res) {
  DataLayer.deleteStoreInfo(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete store info'
