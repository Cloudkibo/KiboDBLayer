...
*/
const LogicLayer = require('./storeinfo.logiclayer')
const MongoInterface = require('./storeinfo_interface_mongo')
const logger = require('./../../../../../components/logger')
const TAG = '/api/v1/kiboengage/abandoned_cart/storeinfo/storeinfo.datalayer.js'

const util = require('util')

exports.findAllStoreInfoObjects = () => {
  return MongoInterface.find()
}

exports.createOneStoreInfoObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateStoreInfo = (body) => {
  if (body.purpose) {
...
exports.findStoreInfoUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
