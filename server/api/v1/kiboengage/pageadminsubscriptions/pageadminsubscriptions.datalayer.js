...
*/
const LogicLayer = require('./pageadminsubscriptions.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/pageadminsubscriptions/pageadminsubscriptions.datalayer.js'

const util = require('util')

exports.findAllPageAdminSubscriptionObjects = () => {
  return MongoInterface.find()
}

exports.createOnePageAdminSubscriptionObject = (body) => {
...
exports.updatePageAdminSubscription = (body) => {
  if (body.purpose) {
...
exports.findPageAdminSubscriptionUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deletePageAdminSubscription = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
