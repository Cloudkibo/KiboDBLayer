...
const DataLayer = require('./pageadminsubscriptions.datalayer')
const TAG = '/api/v1/kiboengage/pageadminsubscriptions/pageadminsubscriptions.controller.js'
const { sendSuccessResponse, sendErrorResponse } = require('../../global/response')
const util = require('util')

exports.index = function (req, res) {
  logger.serverLog(TAG, `Index endpoint is hit:`)
  DataLayer.findAllPageAdminSubscriptionObjects()
    .then(foundObjects => {
...
exports.create = function (req, res) {
  ...
  DataLayer.createOnePageAdminSubscriptionObject(req.body)
    .then(createdObject => {
...
exports.query = function (req, res) {
  ...
  DataLayer.findPageAdminSubscriptionUsingQuery(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.update = function (req, res) {
  ...
  DataLayer.updatePageAdminSubscription(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.delete = function (req, res) {
  ...
  DataLayer.deletePageAdminSubscription(req.body)
    .then(result => {
