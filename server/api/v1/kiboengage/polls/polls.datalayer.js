...
*/
const LogicLayer = require('./polls.logiclayer')
const MongoInterface = require('./poll_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/polls/polls.datalayer.js'

const util = require('util')

exports.findAllPollsObjects = () => {
  return MongoInterface.find()
}

exports.createOnePollObject = (body) => {
...
exports.findPollUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
