...
const TAG = '/api/v1/kiboengage/polls/polls.controller.js'
...
exports.index = function (req, res) {
  DataLayer.findAllPollsObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all polls'
...
exports.query = function (req, res) {
  DataLayer.findPollUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find polls'
...
exports.update = function (req, res) {
  DataLayer.updatePoll(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update poll'
...
exports.delete = function (req, res) {
  DataLayer.deletePoll(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete poll'
