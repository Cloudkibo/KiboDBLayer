...
*/
const LogicLayer = require('./rssFeedPosts.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/rssFeedPosts/rssFeedPosts.datalayer.js'

exports.findAllRSSFeedPosts = () => {
  return MongoInterface.find()
}

exports.createOneRSSFeedPost = (body) => {
...
exports.updateRSSFeedPost = (body) => {
  if (body.purpose) {
...
exports.findRSSFeedPostUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteRSSFeedPost = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
