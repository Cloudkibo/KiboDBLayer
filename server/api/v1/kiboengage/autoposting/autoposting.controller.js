...
exports.index = function (req, res) {
  DataLayer.findAllAutopostingObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all autopostings'
...
exports.query = function (req, res) {
  DataLayer.findAutopostingUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find autopostings'
...
exports.update = function (req, res) {
  DataLayer.updateAutoposting(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update autoposting'
...
exports.delete = function (req, res) {
  DataLayer.deleteAutoposting(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete autoposting'
