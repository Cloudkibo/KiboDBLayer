...
*/
const LogicLayer = require('./autoposting.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/autoposting/autoposting.datalayer.js'

const util = require('util')

exports.findAllAutopostingObjects = () => {
  return MongoInterface.find()
}

exports.createOneAutopostingObject = (body) => {
...
exports.updateAutoposting = (body) => {
  if (body.purpose) {
...
exports.findAutopostingUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
