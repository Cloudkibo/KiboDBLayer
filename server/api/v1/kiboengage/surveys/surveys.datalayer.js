...
const MongoInterface = require('./survey_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/surveys/surveys.datalayer.js'

const util = require('util')

exports.findAllSurveysObjects = () => {
  return MongoInterface.find()
}

exports.createOneSurveyObject = (body) => {
...
exports.findSurveyUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
