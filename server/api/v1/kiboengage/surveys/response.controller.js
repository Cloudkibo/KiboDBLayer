...
const TAG = '/api/v1/kiboengage/surveys/response.controller.js'
...
exports.index = function (req, res) {
  DataLayer.findAllResponseObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all survey responses'
...
exports.create = function (req, res) {
  DataLayer.createOneResponseObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create survey response'
...
exports.query = function (req, res) {
  DataLayer.findResponseUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find survey responses'
...
exports.delete = function (req, res) {
  DataLayer.deleteResponse(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete survey response'
