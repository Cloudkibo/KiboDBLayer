...
*/
const LogicLayer = require('./autoposting_fb_post.logiclayer')
const MongoInterface = require('./autoposting_fb_post_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/autopostingFacebookPosts/autoposting_fb_post.datalayer.js'

const util = require('util')

exports.findAllAutopostingFbPostObjects = () => {
  return MongoInterface.find()
}

exports.createOneAutopostingFbPostObject = (body) => {
  return MongoInterface.create(body)
}

exports.updateAutopostingFbPost = (body) => {
  if (body.purpose) {
...
exports.findAutopostingFbPostsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteAutopostingFbPost = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
