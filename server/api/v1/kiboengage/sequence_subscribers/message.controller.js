...
exports.index = function (req, res) {
  DataLayer.findAllMessageObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all seq mess subscribers '
...
exports.create = function (req, res) {
  DataLayer.createOneMessageObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create seq mess subscriber'
...
exports.query = function (req, res) {
  DataLayer.findMessageUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find seq mess subscribers'
...
exports.update = function (req, res) {
  DataLayer.updateMessage(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update seq mess subscriber'
...
exports.delete = function (req, res) {
  DataLayer.deleteMessage(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete seq mess subscriber'
