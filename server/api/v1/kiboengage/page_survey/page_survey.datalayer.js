...
*/
const LogicLayer = require('./page_survey.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/page_survey/page_survey.datalayer.js'

const util = require('util')

exports.findAllPageSurveyObjects = () => {
  return MongoInterface.find()
}

exports.createOnePageSurveyObject = (body) => {
...
exports.findPageSurveyUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
