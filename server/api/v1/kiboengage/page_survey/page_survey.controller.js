...
const DataLayer = require('./page_survey.datalayer')
const TAG = '/api/v1/kiboengage/page_survey/page_survey.controller.js'
const { sendSuccessResponse, sendErrorResponse } = require('../../../../global/response')
const util = require('util')

exports.index = function (req, res) {
  logger.serverLog(TAG, `Index endpoint is hit:`)
  DataLayer.findAllPageSurveyObjects()
    .then(foundObjects => {
...
exports.create = function (req, res) {
  ...
  DataLayer.createOnePageSurveyObject(req.body)
    .then(createdObject => {
...
exports.query = function (req, res) {
  ...
  DataLayer.findPageSurveyUsingQuery(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.update = function (req, res) {
  ...
  DataLayer.updatePageSurvey(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.delete = function (req, res) {
  ...
  DataLayer.deletePageSurvey(req.body)
    .then(result => {
