...
const TAG = '/api/v1/kiboengage/newsSections/newsSections.datalayer.js'

exports.findAllRSSFeedObjects = () => {
  return MongoInterface.find()
}

exports.createOneRSSFeedObject = (body) => {
...
exports.findRSSFeedUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
