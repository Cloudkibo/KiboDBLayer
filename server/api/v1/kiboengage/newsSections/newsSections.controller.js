...
exports.index = function (req, res) {
  DataLayer.findAllRSSFeedObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all news sections'
...
exports.create = function (req, res) {
  DataLayer.createOneRSSFeedObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create news section'
...
exports.query = function (req, res) {
  DataLayer.findRSSFeedUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find news sections'
...
exports.update = function (req, res) {
  DataLayer.updateRSSFeed(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update news section'
...
exports.delete = function (req, res) {
  DataLayer.deleteRSSFeed(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete news section'
      logger.serverLog(message, `${TAG}: exports.delete`, req.body, {}, 'error')
      sendErrorResponse(res, 500, err.toString())
    })
}
