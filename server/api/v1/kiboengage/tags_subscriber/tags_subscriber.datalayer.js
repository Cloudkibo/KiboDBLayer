...
const TAG = '/api/v1/kiboengage/tags_subscriber/tags_subscriber.datalayer.js'

const util = require('util')

exports.findAllTagSubscriberObjects = () => {
  return MongoInterface.find()
}

exports.createOneTagSubscriberObject = (body) => {
...
exports.updateTagSubscriber = (body) => {
  if (body.purpose) {
...
exports.findTagSubscriberUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteTagSubscriber = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
