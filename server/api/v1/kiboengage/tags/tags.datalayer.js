...
const TAG = '/api/v1/kiboengage/tags/tags.datalayer.js'

const util = require('util')

exports.findAllTagObjects = () => {
  return MongoInterface.find()
}

exports.createOneTagObject = (body) => {
...
exports.findTagUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
