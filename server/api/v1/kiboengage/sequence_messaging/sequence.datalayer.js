...
const MongoInterface = require('./sequence_interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/sequence_messaging/sequence.datalayer.js'

const util = require('util')

exports.findAllSequenceObjects = () => {
...
exports.findSequenceUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
