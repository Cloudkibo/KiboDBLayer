...
*/
const LogicLayer = require('./seq_m_queue.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/sequence_messaging_queue/seq_m_queue.datalayer.js'

const util = require('util')

exports.findAllQueueObjects = () => {
  return MongoInterface.find()
}

exports.createOneQueueObject = (body) => {
...
exports.findQueueUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
