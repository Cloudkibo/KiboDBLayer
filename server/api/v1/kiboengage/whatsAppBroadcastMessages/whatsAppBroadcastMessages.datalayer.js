const LogicLayer = require('./whatsAppBroadcastMessages.logiclayer')
...
exports.insert = (body) => {
  if (body.length > 0) {
    return MongoInterface.insert(body)
  } else {
    // If purpose not found, then reject
    return new Promise((resolve, reject) => { reject(new Error('Data Not Found')) })
  }
}
