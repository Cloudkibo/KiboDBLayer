...
*/
const LogicLayer = require('./page_poll.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/page_poll/page_poll.datalayer.js'

const util = require('util')

exports.findAllPagePollObjects = () => {
  return MongoInterface.find()
}

exports.createOnePagePollObject = (body) => {
...
exports.findPagePollUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
