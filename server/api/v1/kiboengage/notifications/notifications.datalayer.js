...
const TAG = '/api/v1/kiboengage/notifications/notifications.datalayer.js'

const util = require('util')

exports.findAllNotificationObjects = () => {
  return MongoInterface.find()
}

exports.createOneNotificationObject = (body) => {
...
exports.updateNotification = (body) => {
  if (body.purpose) {
...
exports.findNotificationUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteNotification = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
