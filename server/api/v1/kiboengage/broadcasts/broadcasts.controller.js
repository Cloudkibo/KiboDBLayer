...
const TAG = '/api/v1/kiboengage/broadcasts/broadcasts.controller.js'
const { sendSuccessResponse, sendErrorResponse } = require('../../../../global/response')

exports.index = function (req, res) {
  DataLayer.findAllBroadcastsObjects()
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
      const message = err || 'Failed to find all broadcasts'
...
exports.query = function (req, res) {
  DataLayer.findBroadcastUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find broadcasts'
...
exports.delete = function (req, res) {
  DataLayer.deleteBroadcast(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete broadcast'
