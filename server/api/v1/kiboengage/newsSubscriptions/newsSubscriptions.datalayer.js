...
*/
const LogicLayer = require('./newsSubscriptions.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/newsSubscriptions/newsSubscriptions.datalayer.js'

exports.findAllRSSSubscriptions = () => {
  return MongoInterface.find()
}

exports.createOneRSSSubscription = (body) => {
...
exports.updateRSSSubscription = (body) => {
  if (body.purpose) {
...
exports.findRSSSubscriptionsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
...
exports.deleteRSSSubscription = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
