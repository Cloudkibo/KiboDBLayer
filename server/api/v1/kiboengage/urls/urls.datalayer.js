...
*/
const LogicLayer = require('./urls.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/urls/urls.datalayer.js'

const util = require('util')

exports.findAllUrlObjects = () => {
  return MongoInterface.find()
}

exports.createOneUrlObject = (body) => {
...
exports.findUrlUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
