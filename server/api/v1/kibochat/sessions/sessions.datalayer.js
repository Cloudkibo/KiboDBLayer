...
const TAG = '/api/v1/kiboengage/sessions/sessions.datalayer.js'

const util = require('util')

exports.findAllSessionsObjects = () => {
  return MongoInterface.find()
}

exports.createOneSessionsObject = (body) => {
...
exports.findSessionsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
