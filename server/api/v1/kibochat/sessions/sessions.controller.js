...
exports.index = function (req, res) {
  DataLayer.findAllSessionsObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all sessions'
...
exports.create = function (req, res) {
  DataLayer.createOneSessionsObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create session'
...
exports.update = function (req, res) {
  DataLayer.updateSessions(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update session'
...
exports.delete = function (req, res) {
  DataLayer.deleteSessions(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete sessions'
