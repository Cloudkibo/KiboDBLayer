const LogicLayer = require('./whatsAppMessageBlock.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kibochat/whatsapp_message_block/whatsAppMessageBlock.datalayer.js'

const util = require('util')

exports.createOneWhatsAppMessageBlockObject = (body) => {
...
exports.findWhatsAppMessageBlockUsingQuery = (body) => {
  if (body.purpose) {
...
exports.updateWhatsAppMessageBlock = (body) => {
  if (body.purpose) {
...
exports.deleteWhatsAppMessageBlock = (body) => {
  if (body.purpose) {
    let query = body.match
    // If purpose found, then proceed
