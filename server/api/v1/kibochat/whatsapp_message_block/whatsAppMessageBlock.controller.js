...
const DataLayer = require('./whatsAppMessageBlock.datalayer')
const TAG = '/api/v1/kibochat/whatsapp_message_block/whatsAppMessageBlock.controller.js'
const { sendSuccessResponse, sendErrorResponse } = require('../../global/response')
const util = require('util')

exports.create = function (req, res) {
  DataLayer.createOneWhatsAppMessageBlockObject(req.body)
    .then(createdObject => {
...
exports.query = function (req, res) {
  ...
  DataLayer.findWhatsAppMessageBlockUsingQuery(req.body)
    .then(foundObjects => {
...
exports.update = function (req, res) {
  ...
  DataLayer.updateWhatsAppMessageBlock(req.body)
    .then(foundObjects => {
      sendSuccessResponse(res, 200, foundObjects)
    })
    .catch(err => {
...
exports.delete = function (req, res) {
  ...
  DataLayer.deleteWhatsAppMessageBlock(req.body)
    .then(result => {
