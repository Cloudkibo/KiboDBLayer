...
const DataLayer = require('./chatbot.datalayer')
const TAG = '/api/v1/kibochat/chatbot/chatbot.controller.js'
...
exports.index = function (req, res) {
  DataLayer.findAllObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all chatbots'
...
exports.create = function (req, res) {
  DataLayer.createOneObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create chatbot'
...
exports.update = function (req, res) {
  DataLayer.update(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update chatbot'
...
exports.delete = function (req, res) {
  DataLayer.delete(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete chatbot'
