...
const TAG = '/api/v1/kibochat/chatbot_backup/controller.js'
...
exports.index = function (req, res) {
  DataLayer.findAllObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all chatbot_backup'
...
exports.create = function (req, res) {
  DataLayer.createOneObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create chatbot_backup'
...
exports.update = function (req, res) {
  DataLayer.update(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update chatbot_backup'
...
exports.delete = function (req, res) {
  DataLayer.delete(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to delete chatbot_backup'
