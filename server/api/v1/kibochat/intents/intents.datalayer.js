...
*/
const LogicLayer = require('./intents.logiclayer')
const MongoInterface = require('./interface_mongo')
const logger = require('../../../../components/logger')
const TAG = '/api/v1/kiboengage/intents/intents.datalayer.js'

const util = require('util')

exports.findAllIntentsObjects = () => {
  return MongoInterface.find()
}

exports.createOneIntentObject = (body) => {
...
exports.findIntentsUsingQuery = (body) => {
  if (body.purpose) {
    // If purpose found, then proceed
