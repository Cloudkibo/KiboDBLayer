...
exports.index = function (req, res) {
  DataLayer.findAllResponseObjects()
    ...
    .catch(err => {
      const message = err || 'Failed to find all responses'
...
exports.create = function (req, res) {
  DataLayer.createOneResponseObject(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to create response'
...
exports.query = function (req, res) {
  DataLayer.findResponseUsingQuery(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to find responses'
...
exports.update = function (req, res) {
  DataLayer.updateResponses(req.body)
    ...
    .catch(err => {
      const message = err || 'Failed to update response'
...
exports.delete = function (req, res) {
  DataLayer.deleteResponses(req.body)
    .then(result => {
      sendSuccessResponse(res, 200, result)
    })
    .catch(err => {
      const message = err || 'Failed to delete response'
