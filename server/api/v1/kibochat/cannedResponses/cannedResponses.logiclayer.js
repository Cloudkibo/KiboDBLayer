...
exports.validateCreatePayload = (body) => {
  let bool = true
  let arrayOfRequiredFields = ['responseCode', 'responseMessage']
...
exports.prepareMongoAggregateQuery = (body) => {
  ...
  if (body.match) {
    ...
    } else if (body.match.responseId && !body.match.responseId.$exists) {
      body.match.responseId = mongoose.Types.ObjectId(body.match.responseId)
